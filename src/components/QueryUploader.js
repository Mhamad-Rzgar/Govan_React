        ...
        <>
            ...
            <div className='card queryCard' >
                <div className="mb-3">
                    ...
                    <label for="exampleFormControlTextarea1" className="form-label">Simple SQL Command - (Get latest data From Table)</label>
                    <textarea className="form-control form-control-lg" value="SELECT * FROM assetTable.image ORDER BY imageId DESC LIMIT 1" contentEditable="false"></textarea>
                </div>
                <div className="mb-3">
                ...
                <button className='btn btn-secondary' onClick={handleRunQuery}>Run Simple Qurey & download</button>
            </div>
        </>
    );
}
